    ...
    <div
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <input
          ...
          className="rounded-lg text-white border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-white" />
      </div>
      <BackgroundBeams />
    </div>
  );
